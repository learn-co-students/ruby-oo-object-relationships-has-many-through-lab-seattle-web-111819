...
describe 'Patient' do
  ...
  describe '#appointments' do
    it 'returns all appointments associated with this Patient' do
      ...
      appointment = Appointment.new(doctor_who, steve, 'Friday, January 32nd')
      appointment_2 = Appointment.new(doctor_smith, steve, 'Saturday, January 33rd')
      appointment_3 = Appointment.new(doctor_who, mike, 'Sunday, January 34th')
